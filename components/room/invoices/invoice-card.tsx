...
import { useInvoices, useRoommates } from "../contexts/room-context";
...
export function InvoiceCard({
    ...
    const handleDeleteInvoice = useConfirm(
        async () => {
            try {
                setIsDeleting(true);
        ...
        },
        {
            title: "Xoá hóa đơn",
            description:
                "Bạn có chắc chắn muốn xoá hóa đơn này? Hành động này không thể hoàn tác.",
            confirmText: "Xoá",
            variant: "destructive",
        }
    );
            ...
            <CardContent className="space-y-4">
                ...
                {isDeleting ? (
                    ...
                    <div className={"flex gap-2 pt-2"}>
                        ...
                        {(invoice.createdBy === userData!._id ||
                            hasPermission(
                                "room.invoice.delete",
                                membership?.role
                            )) && (
