        ...
        <div className="flex flex-col items-center text-center space-y-4 p-0">
            ...
            <div className="space-y-2">
                <h3 className="font-semibold text-lg">
                    Bạn chưa bật thông báo
                </h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                    Bật thông báo để không bỏ lỡ những cập nhật quan trọng và
                    tin tức mới nhất
                </p>
            </div>
...
export function NotificationList() {
    ...
    return (
        <div
            className="space-y-2 max-h-[70vh] overflow-y-auto overflow-x-hidden"
                    ...
                    >
                        {notification.icon || notification.image ? (
                            <Image
                                width={32}
                                height={32}
                                src={notification.icon! || notification.image!}
                                className="w-8 h-8"
                                alt="Noti"
                            />
                        ) : (
...
export function NotificationDropdown() {
    ...
    return (
        ...
        >
            ...
            <DropdownMenuContent
                align="end"
                className="w-screen md:max-w-sm md:min-w-[300px]"
            >
